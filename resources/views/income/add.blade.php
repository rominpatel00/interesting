                        ...
                        <div class="row">
                            <div class="col-12 row">
                                <div class="page-title-box d-flex align-items-center justify-content-between col-10">
                                    <h4 class="mb-0"><a href="/income" class="" style="color: #495057">Income ></a>&nbsp Add New Transaction</h4>
                                </div>
                                        ...
                                        <div class="row mb-4" >
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="provider">
                                                    ...
                                                    <option selected value="{{$provider->id}}">{{$provider->provider}}</option>
                                                    @endforeach
                                        ...
                                        <div class="row mb-4" >
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="refference">
                                                    ...
                                                    <option selected value="{{$refference->id}}">{{$refference->refference}}</option>
                                                    @endforeach
                                        ...
                                        <div class="row mb-4" >
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="Taker">
                                                    ...
                                                    <option selected value="{{$taker->id}}">{{$taker->taker}}</option>
                                                    @endforeach
