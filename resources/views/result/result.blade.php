                        ...
                        <div class="row">
                            <div class="col-12 row">
                                <div class="page-title-box d-flex align-items-center justify-content-between col-10">
                                    <h4 class="mb-0">Result Management</h4>
                                    ...
                                    <table id="example" class="table table-striped mb-0" style="width:100%">
                                      ...
                                      @foreach ($results as $result)
                                            <tr>
                                                ...
                                                <td>{{ $result->correctanswer. '/' . $result->wronganswer }}</td>
                                                <td>{{ $result->created_at }}</td>
                                                <td> <a href="#myModal" class="deletemodal trigger-btn" data-path="result" data-id="{{$result->id}}" data-toggle="modal">Delete</a></td>
                                             </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
