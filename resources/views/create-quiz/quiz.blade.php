                        ...
                        <div class="row">
                            <div class="col-12 row">
                                <div class="page-title-box d-flex align-items-center justify-content-between col-10">
                                    ...
                                    <div class="col-2">
                                    <a href="/create-quiz/create" class="btn btn-primary">Add Question</a>
                                    </div>
                            </div>
                        </div>
                                    ...
                                    <table id="example" class="table table-striped mb-0" style="width:100%">
                                      ...
                                      @foreach ($quizzes as $quiz)
                                            <tr>
                                                ...
                                                <td><a href="/create-quiz/edit/{{ $quiz->id }}"><i class="uil uil-pen font-size-18"></i> Edit </a>| <a href="#myModal" class="deletemodal trigger-btn" data-path="create-quiz" data-id="{{$quiz->id}}" data-toggle="modal">Delete</a></td>
                                             </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
