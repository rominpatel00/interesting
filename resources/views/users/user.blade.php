                                    ...
                                    <table id="example" class="table table-striped mb-0" style="width:100%">
                                      ...
                                      @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->comment }}</td>
                                                <td><a href="/users/edit/{{ $user->id }}"><i class="uil uil-pen font-size-18"></i> Edit </a>| <a href="#myModal" class="deletemodal trigger-btn" data-path="users" data-id="{{$user->id}}" data-toggle="modal">Delete</a></td>
                                                {{-- <td><a href="/customer/edit/{{ $customer->customer_id }}"> Edit </a>| <button href="/customer/destroy/{{$customer->customer_id}}"> Delete</button></td> --}}
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
