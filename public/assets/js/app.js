$(".deletemodal").click(function(){
  ...
  $("#deleteconfirm").attr("href","/"+path+"/destroy/"+cID);
});
...
function changeView(){
  var len = document.getElementsByClassName("question-bank").length;
  if(i+2 == len){
  ...
  document.getElementsByClassName("question-bank")[i].style.display="none";
  document.getElementsByClassName("question-bank")[i+1].style.display="block";
  $(".next-button").attr('disabled',true);
  i++;
}
$('#tiles_is_book_pattern').on('change', function() {
  if(this.value == 1){
      $('.tiles_book_pattern_tile').css('display','');
      $('.row.mb-4.single-img').css('display','none');
  }
    else{

        $('.main-multi-img.row.mb-4').css('display','none');
        $('.tiles_book_pattern_tile').css('display','none');
        $('.row.mb-4.single-img').css('display','');
    }
});

if($("#tiles_book_pattern_tile").val()){
  $('.tiles_book_pattern_tile').css('display','');
  $('.row.mb-4.single-img').css('display','none');
}
else{
...
$(".image-box").click(function(event) {
  ...
  $(".image-box").children("img").each(function(){
    // debugger
    if($(this).attr("src")){
...
$("#tiles_book_pattern_tile").change(function() {
$(".multi-img.active").removeClass("active")
id = this.value; 
if(id){
$('.main-multi-img').css('display','');
}
else{
  $('.main-multi-img').css('display','none');
}
$("#"+id+"").addClass("active");
});
...
if($("#tiles_book_pattern_tile").val()){
  $(".multi-img.active").removeClass("active")
  id = $("#tiles_book_pattern_tile").val(); 
  if(id){
  $('.main-multi-img').css('display','');
  }
  else{
