$(document).ready(function () {
    $("#example").DataTable();
    $(".dataTables_length select").addClass("custom-select custom-select-sm form-control form-control-sm form-select form-select-sm");
    $("#example_filter label input").addClass("form-control form-control-sm");
    $("#example_filter label input").css("width","auto");
    $("#example_filter label input").css("display","inline");
    ...
    var N = function (h) {
                    ...
                    for (g = b.length; e < g; e++)
                        (c = b[e]),
                            ...
                            i.indexOf &&
                                -1 !== i.indexOf("&") &&
                                ((qa.innerHTML = i),
                                (i = Wb ? qa.textContent : qa.innerText)),
        ...
        function W(a) {
            ...
            if (q.outerWidth() < g) {
                ...
                if (
                    ...
                    M.width = s(t - f);
                ("" === c || "" !== d) &&
                    P(a, 1, "Possible column misalignment", 6);
            } else t = "100%";
            k.width = s(t);
            j.width = s(t);
        ...
        function Ca(a) {
            ...
            for (k = 0; k < d.length; k++)
                (l = c[d[k]]),
                    null !== l.sWidth &&
                        ((l.sWidth = Cb(l.sWidthOrig, m)), (o = !0));
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    x(
                        ...
                        "aoDrawCallback",
                        function () {
                            (k.bSorted || z(k) === "ssp" || t.bDeferRender) &&
                                sa(k);
                        },
                        "sc"
                    );
                    ...
                    0 === i.length || 0 === i.children().length
                        ...
                        : 0 < i.length &&
                          ((k.nTFoot = i[0]), aa(k.aoFooter, k.nTFoot));
                    if (g.aaData)
        ...
        var Sb = function (a, b, c) {
            "ssp" == z(a)
                ...
                : (B(a, !0),
                  na(a, [], function (c) {
                      ja(a);
                      for (var c = oa(a, c), d = 0, g = c.length; d < g; d++)
                          I(a, c[d]);
                      L(a, b);
                      B(a, !1);
                  }));
        ...
        var Za = function (a, b) {
                ...
                for (g = a.length; f < g; f++) {
                    ...
                    for (i = e.length; j < i; j++)
                        (d = b(
                            "string" === typeof e[j] ? h.trim(e[j]) : e[j]
                        )) &&
                            d.length &&
                            c.push.apply(c, d);
                }
                ...
                if (a === l) e = c.aoColumns[d].bVisible;
                    ...
                    if (a === l) e = e.bVisible;
                        ...
                        if (e.bVisible !== a) {
                            ...
                            ba(c, c.aoFooter);
                            if (b === l || b)
                                V(c), (c.oScroll.sX || c.oScroll.sY) && W(c);
